...
FCEUX_VERSION = b03647e1cfdaf11789b48b7451c3b78610465e81
FCEUX_SITE_METHOD = git
FCEUX_SITE = https://github.com/retrofw/fceux
FCEUX_LICENSE = GPL-2.0
FCEUX_LICENSE_FILES = COPYING

FCEUX_DEPENDENCIES = sdl sdl_image sdl_mixer sdl_ttf zlib

FCEUX_CFLAGS = $(TARGET_CFLAGS) $(subst $\",,$(BR2_TARGET_OPTIMIZATION)) -ffast-math -funsafe-math-optimizations
